  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.success) {
        ...
        toast.info("Please verify your email address to complete registration");
      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading || !agreeToTerms || !isPasswordStrong}
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <button
                ...
                className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm bg-white dark:bg-gray-700 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-600 transition"
              >
          ...
          <div className="mt-6 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
            <div className="flex">
              ...
              <div className="text-sm text-blue-800 dark:text-blue-200">
                ...
                <p>You'll receive a verification email after registration. Please check your inbox.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-6 text-center">
          ...
          <p className="text-gray-600 dark:text-gray-300 mt-2">
            ...
            <Link to="/seller/register" className="text-blue-600 hover:text-blue-700 font-medium">
              Become a Seller
            </Link>
          </p>
        </div>
